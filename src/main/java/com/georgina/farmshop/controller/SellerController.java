...
public class SellerController {
    ...
    public ResponseEntity<Seller> createSeller(
        ...
        String text = "Welcome to our Farm shop! Verify your email on this link:  ";
    ...
    @GetMapping
    public ResponseEntity<List<Seller>> getAllSellers(    // List<Seller> is the return type - gets serialized to JSON array
                                                          @RequestParam(required = false) AccountStatus status) {
        // you delegate to your business layer instead of jamming db logic in your controller
        List<Seller> sellers = sellerService.getAllSellers(status);
        // puts your sellers list into the body
        // also your List<Seller> becomes a JSON array
